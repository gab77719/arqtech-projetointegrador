        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="border border-gray-700 rounded-lg p-8">
            ...
            <div className="text-gray-300 leading-relaxed space-y-4">
              <p>
              A brita na construção civil é um material pétreo obtido da fragmentação mecânica de rochas, utilizado para dar estrutura e resistência a diversos projetos.
              </p>
            </div>
          </div>
        </div>
