        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="border border-gray-700 rounded-lg p-8">
            ...
            <div className="text-gray-300 leading-relaxed space-y-4">
              <p>
               Argamassa é uma mistura de cimento, areia e água, geralmente com a adição de cal e aditivos, que serve como "cola" para unir e revestir superfícies na construção civil.
                </p>
              ...
              <p>
                ...
                <br />
                - Por tempo em aberto: Resistência logo após a aplicação.
                <br />
                - Cura normal: Resistência após um período de cura padrão.
                <br />
